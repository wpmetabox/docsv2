...
- It does not look and feel like a post or a page, or
...
To understand the settings in detail, [see the docs](/extensions/mb-custom-post-type/#post-type-settings) for the MB Custom Post Types & Custom Taxonomies extension.

:::

## Creating custom taxonomies

When you have a lot of posts of a custom post type, you might want to categorize them. For example, categorize music albums by genre or artist. To categorize posts like that, you need custom taxonomies.

Taxonomies in WordPress are a mechanism for grouping posts, like category and tag. In the example above, "genre" and "artist" are custom taxonomies for the custom post type "music album".
...
To understand the settings in detail, [see the docs](/extensions/mb-custom-post-type/#taxonomy-settings) for the MB Custom Post Types & Custom Taxonomies extension.
...
After creating a custom post type, [add custom fields](/custom-fields/) to add more details for posts of that post type! That is the most important part of the whole process and is the heart of Meta Box.
