...
These attributes are used by MB Blocks for easier to style and manipulate the block. If you override these attributes, field's value will override the default values generated by MB Blocks.
