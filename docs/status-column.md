...
## Status column for posts of custom post type

To add status column into the table of the post list of a custom post type, when you creating that post type, navigate to the **Features** tab, then enable the setting as below:
