...
[![filter taxonomy plugins](/tutorials/guide-43.png) <h3 class="items_titles">Filter posts by taxonomy in the admin dashboard
</h3>](/tutorials/filter-posts-by-taxonomy-in-admin-dashboard/)
