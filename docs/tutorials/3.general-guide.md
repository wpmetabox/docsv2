...
[![Rename taxonomy without losing data](./thumbnails/guide-50.png) <h3 class="items_titles">Rename taxonomy without losing data</h3>](/tutorials/rename-taxonomy-without-losing-data)
