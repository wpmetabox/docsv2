...
![Go to Meta Box > Post Types to create new post types for Instructors and Courses](https://i.imgur.com/YLFWpYh.png)
...
![Add the Post Title element to display the instructor name.](https://i.imgur.com/KW9ChHv.png)
