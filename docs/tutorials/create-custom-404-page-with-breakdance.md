...
![An example of a custom 404 page](https://i.imgur.com/xRd5V9C.png)
...
![The 404 page is still blank now](https://i.imgur.com/B29WyQr.png)
...
![Some typical fields for the 404 page as example](https://i.imgur.com/s66upgA.png)
...
![Add the subfields for the label and URL of the button](https://i.imgur.com/0JqyIks.png)

In my specific case, I set the group as collapsible and named for the button.

![Set the name of the button](https://i.imgur.com/0HEKstR.png)

If you want to add more than one button, make the group cloneable by enabling the corresponding option.

![Set the group is clonable to add more than one button](https://i.imgur.com/ZLBCruT.png)
...
![In the Settings tab, set the Location as Settings page, and choose the created settings page to apply the fields to it.](https://i.imgur.com/bveviUt.png)
...
![Go to Breakdance > Templates, and add a new template](https://i.imgur.com/h9y0Dul.png)

Breakdance supports a specific template for the 404 page.

![Breakdance supports a specific template for the 404 page](https://i.imgur.com/Cbudm9i.png)

Just choose that option. Then, edit it in Breakdance.

![Choose that template and edit it in Breakdance](https://i.imgur.com/D4kXFM4.png)
...
![Add layout for the 404 page as you want](https://i.imgur.com/kC09h8j.png)
...
![Add an Image element](https://i.imgur.com/GIgadcD.png)
...
![Click on the dynamic data icon to get data from](https://i.imgur.com/3OO3P75.png)

Then, in the appeared pop-up, look for the **Meta Box** section, and choose the name of the field that we save the image.

![Choose the name of the field that we save the image in the Metabox section](https://i.imgur.com/5bUbVs2.png)

In the second column, add a **Text** element for the message.

![Add a Text element for the message](https://i.imgur.com/QKmlxrq.png)

Also, use the dynamic data button, and select the field for the message.

![Select the field for the message](https://i.imgur.com/Qe1hgwm.png)
...
![Add a Code Block element](https://i.imgur.com/AOqkIQs.png)
...
![Add some code to get and display data from cloneable group in the settings page](https://i.imgur.com/FBHtDoa.png)
...
![All of the data displayed but the button is in the text format](https://i.imgur.com/Joh1lx7.png)
...
![Change some settings in the Style tab of each element to have the desired look](https://i.imgur.com/3KiDq47.png)

In the code block where we display the button, I also add some **`div`** tags and classes. Also, modify it.

![Modify the code a little bit](https://i.imgur.com/a9rTZCc.png)
...
![Use CSS to style the button](https://i.imgur.com/xAtLpir.png)

And, this is the final look of my 404 page.

![The new look of the 404 page after styling](https://i.imgur.com/iRIComK.png)
...
![Change the content in the custom fields to have a new 404 page](https://i.imgur.com/jFMRuGc.gif)
