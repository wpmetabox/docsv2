...
![Example of an archive page displays products on sale](https://i.imgur.com/mhYhltr.png)
...
![Create a new custom post type for products](https://i.imgur.com/dHPs2V5.png)
...
![Created custom fields for extra information of products](https://i.imgur.com/TWzWP5Z.png)
...
![Show created fields as admin columns](https://i.imgur.com/khMin0M.png)

Do it by checking this box in both fields’ settings.

![Set the custom fields as show as admin column](https://i.imgur.com/WpcWAYf.png)
...
![Set the location for the created fields](https://i.imgur.com/xmmmpmW.png)

When creating a new post in the **Cuisines** post type, you’ll see all the created custom fields.

![All the created custom fields appear in the post editor](https://i.imgur.com/mv5X2Qj.png)
...
![Disable the page's title](https://i.imgur.com/tHSqnZO.png)
...
![Add the Section element to cover all the content of the page](https://i.imgur.com/i349C4O.png)
...
![Choose the Post Title option to get the page's title.](https://i.imgur.com/CZI9MMm.png)

You see the title of the page displayed immediately.

![The title of the page displayed immediately](https://i.imgur.com/3sgbk2Y.png)
...
![Add container and column elements.](https://i.imgur.com/nZXv3Bc.png)
...
![Go to the Advanced tab, choose Repeater Options and enable the repeater provider.](https://i.imgur.com/ZFMXTo4.png)
...
![Get all the posts from the Cuisines post type.](https://i.imgur.com/Jx9mhTQ.png)

Remember to turn on the **Enable the repeater consumer** option to display all the posts in the chosen post type.

![Turn on the Enable the repeater consumer option to display all the posts in the chosen post type.](https://i.imgur.com/yP0biNh.png)
...
![In the Element visibility option, choose Advanced conditions. Then, the Element Condition option will display.](https://i.imgur.com/0izo2Yn.png)
...
![The condition of getting the wanted posts](https://i.imgur.com/oNb3HHr.png)
...
![As we haven't sealected any product information to display yet, it remains empty.](https://i.imgur.com/Hb6uakY.png)
...
![Get the image of the dish from custom field.](https://i.imgur.com/zYzXxA2.png)
...
![Add the Heading element for the dish's name](https://i.imgur.com/yVr5JCy.png)

You see that the dishes names are displayed.

![The dishes names are displayed](https://i.imgur.com/nV9MVK2.png)
...
![The dishes names are displayed](https://i.imgur.com/aSq6v15.gif)
...
![Add the currency unit](https://i.imgur.com/tSo6xr2.png)

For the promotional price information, do likewise.

![Get the promotional price information](https://i.imgur.com/iSFwJeC.png)
...
![Get the dish’s description form custom field](https://i.imgur.com/LfLsaAr.png)

Now the dishes' descriptions have been obtained.

![The dishes' descriptions have been obtained](https://i.imgur.com/xEL0G3N.png)
...
![All of the dishes along with the information that we’re looking for](https://i.imgur.com/mhYhltr.png)
...
![Which one has the promotional price will be the one displayed on the page.](https://i.imgur.com/khMin0M.png)
