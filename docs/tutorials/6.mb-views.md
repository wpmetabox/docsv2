...
[![manage and displaying course schedule](./thumbnails/views-37.png) <h3 class="items_titles">Manage and displaying course schedule</h3>](/tutorials/managing-displaying-course-schedule-with-filters/)

[![filter posts by date picker field](./thumbnails/views-38.png) <h3 class="items_titles">Filter posts by date picker field</h3>](/tutorials/filter-posts-by-date-picker-field/)

[![pin-newest-featured-posts](./thumbnails/views-39.png) <h3 class="items_titles">Pin Newest Featured Posts</h3>](/tutorials/pin-newest-featured-posts-above-regular-posts-mb-views/)
