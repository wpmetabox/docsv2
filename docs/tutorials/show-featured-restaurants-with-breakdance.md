...
![Example of some featured posts on a page](https://i.imgur.com/FOO2VOm.png)
...
![Example of some featured posts on a page](https://i.imgur.com/e8ryCDS.png)

2. Creating custom fields

Go to **Meta Box** > **Custom Fields** to create fields to save extra information for the restaurants as usual.

![Example of some featured posts on a page](https://i.imgur.com/oUL3R2H.png)
...
![Example of some featured posts on a page](https://i.imgur.com/kRt66vw.png)
...
![Example of some featured posts on a page](https://i.imgur.com/gmFYSWT.png)
...
![Example of some featured posts on a page](https://i.imgur.com/2tvXUEv.png)

You can see how it displays on the admin dashboard.

![Example of some featured posts on a page](https://i.imgur.com/8fMSfmW.png)
...
![Example of some featured posts on a page](https://i.imgur.com/AoaYOjE.png)
...
![Example of some featured posts on a page](https://i.imgur.com/VWg9z3w.gif)
...
![Example of some featured posts on a page](https://i.imgur.com/qR1uaPj.png)

Remember to set a post for the live preview.

![Example of some featured posts on a page](https://i.imgur.com/EzcCqG5.png)

My global block is to display the information of each post in a box like this.

![Example of some featured posts on a page](https://i.imgur.com/av6oEk5.png)

3.1 Setting the condition to get featured posts

First, select the **Div** element to cover the block.

![Example of some featured posts on a page](https://i.imgur.com/TWfHTwa.png)
...
![Example of some featured posts on a page](https://i.imgur.com/6AEPoMT.gif)

Choose the **Dynamic Data** option from the list to set the condition based on the data saved in custom fields.

![Example of some featured posts on a page](https://i.imgur.com/CwyNX24.png)
...
![Example of some featured posts on a page](https://i.imgur.com/VqAq30K.png)
...
![Example of some featured posts on a page](https://i.imgur.com/HTiTY4N.png)
...
![Example of some featured posts on a page](https://i.imgur.com/NyKZwf3.png)

Then, choose the **Featured Image** option from the **Post** section.

![Example of some featured posts on a page](https://i.imgur.com/O3h6Xqc.png)

You see that the restaurant’s image is displayed immediately.

![Example of some featured posts on a page](https://i.imgur.com/B3Bpna3.png)
...
![Example of some featured posts on a page](https://i.imgur.com/jRIvwkb.gif)

To get the restaurant’s name automatically, add the **Heading** element, and connect it with the title of the post.

![Example of some featured posts on a page](https://i.imgur.com/2VMdsDf.png)

As a result, the name of the restaurant appears.

![Example of some featured posts on a page](https://i.imgur.com/D0DNs0c.png)

For the address information, do the same with the voucher. Add a **Text** element, then insert data from the **Address** field.

![Example of some featured posts on a page](https://i.imgur.com/IenArYL.png)
...
![Example of some featured posts on a page](https://i.imgur.com/Iv8Z4CS.gif)
...
![Example of some featured posts on a page](https://i.imgur.com/7DHiei7.png)
...
![Example of some featured posts on a page](https://i.imgur.com/NWE1fQC.png)
...
![Example of some featured posts on a page](https://i.imgur.com/q4XGOUm.png)
...
![Example of some featured posts on a page](https://i.imgur.com/SGJUJbT.png)
...
![Example of some featured posts on a page](https://i.imgur.com/6eFyxem.png)
