...
![The upcoming events section is created by MB Views.](https://i.imgur.com/xSyaxCt.png)
...
![Assume that today isJanuary 10th.](https://i.imgur.com/GfpVAme.png)
...
![An event with an end date beyond January 10th will be shown on the page.](https://i.imgur.com/TCg2vTG.png)
...
![Create a new post type for the events.](https://i.imgur.com/yyfMGTt.png)
...
![Some typical custom fields to store event information](https://i.imgur.com/wqkeGqN.png)
...
![Go to Meta Box > Custom Fields to create fields.](https://i.imgur.com/Bl8iZWM.png)

I’ll choose the **Date Picker** field type for both the start and end date of the event.

![Choose the Date Picker field type for the start and end date of the event.](https://i.imgur.com/YBxf59P.png)
...
![Turn on the button to show the date on the management dashboard.](https://i.imgur.com/P0k6zHg.png)
...
![Set the location to apply these fields to the Event post type.](https://i.imgur.com/GUYQ8N3.png)

Then, in the post editor, you will see the created custom fields.

![The created custom fields in the post editor.](https://i.imgur.com/wqkeGqN.png)

Simply input data into them.

Here are some posts that I made, for example.

![Some posts that I created for example.](https://i.imgur.com/p2lQEeM.png)
...
![Go to Meta Box > Views to create a new template for the upcoming events section.](https://i.imgur.com/gv0qKuC.png)
...
![Insert fields into the template by clicking the Insert Fields button > choose any fields on the right sidebar to get data from them.](https://i.imgur.com/hzqoHdE.png)

Or, you can also add some lines of code to the **Template** tab, like this:

![Add some lines of code to the Template tab.](https://i.imgur.com/H59IscS.png)
...
![For the image of the event, choose the Post thumbnail field.](https://i.imgur.com/XQaxxEn.png)

Next, choose **Post title** to display the title of the event.

![Choose Post title to display the title of the event.](https://i.imgur.com/6rMbokY.png)
...
![Look for the Event Information field group.](https://i.imgur.com/AlOa5Jz.png)

**Meta Box** also provides some options to set the output of the date. So, just set the one that fits your needs.

![Meta Box also provides some options to set the output of the date.](https://i.imgur.com/jlFr28H.png)

Do the same to display the end date and location.

![Display the end date and location.s](https://i.imgur.com/HbeqDs6.png)
...
![Keep the settings of the template’s type as shortcode to display this template anywhere easier.](https://i.imgur.com/dVBIP7S.png)

Notice that you should copy the generated shortcode to use it later.

![Copy this generated code to use it later.](https://i.imgur.com/ZjLJxND.png)

Now, go to any place where you want to display the upcoming events, add the **Shortcode** block.

![Add the Shortcode block.](https://i.imgur.com/JK2whdN.png)

Following this, insert the created shortcode into the box.

![Paste the created shortcode in the box.](https://i.imgur.com/Q3fWTyz.png)

So, we’ve just finished getting all the posts of the **Event** post type. Again, I just specifically mentioned "all the posts".

![Display all the posts of the event post type.](https://i.imgur.com/uLctyxt.png)

If you want to style the section, go back to the template and add some codes.

![If you want to style the section, back to the template, add some codes.](https://i.imgur.com/fyKD6f7.png)
...
![Add some div tags and classes to style easily.](https://i.imgur.com/r2sO8B3.png)
...
![Go to the CSS tab and add some codes](https://i.imgur.com/CydufwK.png)

Go to the frontend, the new look has been done.

![The new look has been done.](https://i.imgur.com/WwNf3Yk.png)
...
![Add the specific line of code to compare the end date with the current date.](https://i.imgur.com/f6ivqLl.png)
...
![You can see the upcoming events clearly on the frontend.](https://i.imgur.com/xSyaxCt.png)
