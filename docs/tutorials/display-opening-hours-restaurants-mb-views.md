...
This rule means this group will be displayed when the **Choose an Option** field is selected as **All days have the same opening hours8** option which has the value is `all_days_are_the_same`.
