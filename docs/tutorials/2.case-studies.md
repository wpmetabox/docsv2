...
<ul>
	...
	<li><a href="/tutorials/filter-posts-by-taxonomy-mbviews/">Using MB Views</a></li>
</ul>
		</div>
		<div className="items">
...
<ul>
	...
	<li><a href="/tutorials/build-hotel-booking-website-p3-frontend/">Booking page in frontend</a></li>
</ul>
		</div>
		<div className="items">
...
<ul>
	...
	<li><a href="/tutorials/filter-posts-by-relationships-with-oxygen/">Using Meta Box + Oxygen</a></li>
		...
		<div className="items">
			<h2>Reorder Items by Cloneable Fields</h2>

[![Reorder items by cloneable fields](thumbnails/case-46.png)](/tutorials/reorder-items-by-their-values-from-cloneable-custom-fields/)
<ul>
	<li><a href="/tutorials/reorder-items-by-their-values-from-cloneable-custom-fields/">Using MB Views + Bricks</a></li>
