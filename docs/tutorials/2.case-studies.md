...
![styling post](/tutorials/views-27.png)
<ul>
...
![styling post](/tutorials/case-36.png)
<ul>
...
![styling post](/tutorials/case-37.png)
<ul>
...
![styling post](/tutorials/case-38.png)
<ul>
	...
	<li><a href="/tutorials/create-timeline-mb-views/">Using MB Views</a></li>
		...
		<div className="items">
			<h2>Show Events Related</h2>

![styling post](/tutorials/case-39.png)
<ul>
	<li><a href="/tutorials/display-related-posts-based-on-shared-relationship/">Display related posts by shared relationship
</a></li>
</ul>
		</div>
	</div>
