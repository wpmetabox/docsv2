...
![styling post](/tutorials/case-41.png)
<ul>
...
![styling post](/tutorials/case-42.png)
<ul>
	<li><a href="/tutorials/create-pricing-table-page-with-breakdance/">Using Meta Box + Kadence</a></li>
</ul>
		</div>
	</div>
</div>
